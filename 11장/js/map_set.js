...
// set() 메서드를 여러번 쓰기 귀찮을 떄, 연결해서 사용할 수 있다.
...
let numSet3 = new Set([1,2,3,4,5,6,7,2,8,3,5,3,4,]);
console.log(numSet3)         //중복되는 값을 제거 하고 셋을 만듬

console.log(numSet1.keys());
console.log(numSet1.values());
console.log(numSet1.entries());

//values 메서드를 사용해 값을ㄹ 가져와 for of 반복문으로 language 셋에
//language 셋에 있는 값을 출력하시오.
let language = new Set(['js','c','python','c','js']);
for(let lan of language.values()){
    console.log(lan);
}